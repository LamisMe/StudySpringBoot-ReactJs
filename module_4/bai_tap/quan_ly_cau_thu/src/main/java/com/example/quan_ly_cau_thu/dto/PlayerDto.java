...
public class PlayerDto implements Validator {
    ...
    public PlayerDto(Integer id, String idPlayer, String name, String avatar, String dateOfBirth, Integer experience, boolean status, Position position, Team team) {
        this.id = id;
